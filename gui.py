...
class userGui(object):
    ...
    def read_config(self):
        ...
        if self._json_data["h_job_steps生成路径"].find('h_job_steps.csv')>-1 and os.path.exists(self._json_data['h_job_steps生成路径']):
            self._app.setEntry('h_job_steps_user_fileentry',self._json_data["h_job_steps生成路径"])
            ...
            if dir.find(check_path)>-1:
                ...
                if check_path=='h_job_steps.csv':
                    ...
                    if self._data_h_job_steps is not None:
                        ...
                        self._json_data['h_job_steps生成路径']=dir
                    else:
